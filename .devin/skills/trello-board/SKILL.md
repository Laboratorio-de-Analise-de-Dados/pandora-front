...
- **Documentação durável**: PRDs no repo privado `pandora-docs`
  (`pandora-docs/prd/`) = o quê; ADRs de UI/convenção em `docs/adr/` e os
  sensíveis em `pandora-docs/adr/front/` = o porquê. PRD/ADR **não** é
