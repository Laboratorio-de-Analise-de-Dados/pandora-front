...
| Feature                          | Observação                                                                                                                                                  |
| -------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| UI de compensação (BE-22)        | Badge "Compensado" (`experiment.compensated` já sai na listagem), leitura de `.../compensations/embedded`, futura: editor de matriz + marcação de controles |
