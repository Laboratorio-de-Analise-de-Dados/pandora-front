...
| [FE-36](FE-36-analise-de-dados-graficos-exportacao.md) | Área de análise: gráficos comparativos de stats + distribuições + export PNG/SVG; ANOVA é fase 2 | Não iniciado — fase 1 no v1 |
